  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta property="og:description" content="Event hari guru SMANSA." />
        ...
        <meta name="twitter:description" content="Event hari guru SMANSA." />
        ...
        <meta name="description" content="Event hari guru SMANSA" />
        <meta name="author" content="Eriza Zehezkiel Gracia" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className={styles.main}>
        <section className="hero tengah">
          <h1 className='putih'>Penampilan</h1>
          <h2 className='putih'>
            <ul>
            Dari kelas Kelas X:<br/>
            X MIPA 3<br/>
            X MIPA 4<br/>
            X MIPA 9<br/>
            X IPS 1<br/>
